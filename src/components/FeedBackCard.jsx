  ...
  mr-0 my-5 feedback-card'>
    ...
    <div className='flex flex-row'>
      ...
      <div className="flex flex-col ml-4">
        <h4 className="font-popping font-semibold text-[20px] leading-[32px] text-white">{name}</h4>
        <p className="font-popping font-normal text-[16px] leading-[24px] text-dimWhite">{title}</p>
      </div>
    </div>
  </div>
)
